                ...
                for (int j = 0; j < n; ++j)
                {
                    ...
                    if (x != 0)
                    {
                        ...
                        else    //values array isn't empty
                        {
                            ...
                            int* values_new = nullptr;
                            try {
                                values_new = new int[matrix_ptr->nz];
                            }
                            catch (std::bad_alloc& ba) {
                                std::cout << "------ Can't allocate space for matrix: " << ba.what() << std::endl;
                                matrix_delete(matrix_ptr);
                            ...
                            int* columns_new = nullptr;
                            try {
                                columns_new = new int[matrix_ptr->nz];
                            }
                            catch (std::bad_alloc& ba) {
                                std::cout << "------ Can't allocate space for matrix: " << ba.what() << std::endl;
                                matrix_delete(matrix_ptr);
...
int main()
{
    ...
    int* vec = Lab_1::form_vector(matrix_ptr, Lab_1::criterium);
    ...
    Lab_1::matrix_delete(matrix_ptr);
